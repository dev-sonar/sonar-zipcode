...
class ZipcodePrefectureTableCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = 'zipcode:prefecture_table';
     ...
     * @var string
     */
    protected $description = 'Create a migration for the prefecture database table';
